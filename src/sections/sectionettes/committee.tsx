...
const committeeMembers = [
    ...
    { title: "Pr.", name: "N. MELIKCHI", affiliation: "University of Massachusetts Lowell, USA", country: "us" },
    ...
    { title: "Pr.", name: "A. BOUSSEKSOU", affiliation: "LCC-CNRS, Toulouse France", country: "fr" },
    { title: "Pr.", name: "M. SEKKAL-REHAL", affiliation: "Sidi Bel Abbès University, Algeria", country: "dz" },
    { title: "Pr.", name: "IMAD BELABBAS", affiliation: "Bejaia University, Algeria", country: "dz" },
    { title: "Pr.", name: "L. ZEROUAL", affiliation: "Setif 1 University, Algeria", country: "dz" },
    { title: "Pr.", name: "A. AIDI", affiliation: "Biskra University, Algeria", country: "dz" },
    { title: "Pr.", name: "N. MAOUCHE", affiliation: "Setif 1 University, Algeria", country: "dz" },
    { title: "Dr.", name: "K. ADAIKA", affiliation: "Biskra University, Algeria", country: "dz" },
    { title: "Dr.", name: "A. SAYAH", affiliation: "Setif 1 University, Algeria", country: "dz" },
    { title: "Pr.", name: "A. ZEGADI", affiliation: "Setif 1 University, Algeria", country: "dz" },
    { title: "Pr.", name: "L. MITICHE", affiliation: "Tizi ouzou University, Algeria", country: "dz" },
    { title: "Dr.", name: "S. MOUSSAOUI", affiliation: "Boumerdes University, Algeria", country: "dz" },
    { title: "Dr.", name: "N. MOHAMED", affiliation: "Ain Shams University, Egypt", country: "eg" },
    { title: "Pr.", name: "C. BELEBCHOUCHE", affiliation: "Setif 1 University, Algeria", country: "dz" },
    ...
    { title: "Pr.", name: "N. ALIOUANE", affiliation: "Bejaia University, Algeria", country: "dz" },
    ...
    { title: "Pr.", name: "H. AYADI", affiliation: "Skikda University, Algeria", country: "dz" },
    { title: "Pr.", name: "S. I. AHMED", affiliation: "Taif University, Saudi Arabia", country: "sa" },
    { title: "Pr.", name: "A. SAKER", affiliation: "Biskra University, Algeria", country: "dz" },
    { title: "Dr.", name: "O. MOUMENI", affiliation: "Setif 1 University, Algeria", country: "dz" },
    { title: "Pr.", name: "C. BOUREMAL", affiliation: "Biskra University, Algeria", country: "dz" },
    ...
    { title: "Dr.", name: "R. KERKOUR", affiliation: "Mila University, Algeria", country: "dz" },
    ...
    { title: "Pr.", name: "F. KAHOUL", affiliation: "M'Sila University, Algeria", country: "dz" },
    { title: "Dr.", name: "N. CHAHMANA", affiliation: "Setif 1 University, Algeria", country: "dz" },
    { title: "Dr.", name: "R. AYECHE", affiliation: "BBA University, Algeria", country: "dz" },
    ...
    { title: "Dr.", name: "S. ALMI", affiliation: "Biskra University, Algeria", country: "dz" },
    ...
    { title: "Dr.", name: "Z. DJATOUI", affiliation: "Skikda University, Algeria", country: "dz" },
    { title: "Pr.", name: "S. LOUNIS", affiliation: "Martin Luther University, Halle-Wittenberg Germany", country: "de" },
    { title: "Pr.", name: "R. CHTOUROU", affiliation: "Research and Technology Center of Energy", country: "tn" }, // Assuming Tunisia based on context/proximity, but general affiliation
    { title: "Pr.", name: "Y. BENARIOUA", affiliation: "M'sila University, Algeria", country: "dz" },
    { title: "Dr.", name: "M. ALI", affiliation: "Badr University, Egypt", country: "eg" },
    { title: "Pr.", name: "N. BAADJI", affiliation: "M’Sila University, Algeria", country: "dz" },
  ];
